...
import br.edu.infnet.financialprofileapp.databinding.FragQ1Binding

class Quiz1 : Fragment(R.layout.frag_q1) {
    var radioGroup: RadioGroup? = null
    lateinit var radioButton: RadioButton
    private var binding: FragQ1Binding? = null
    ...
    override fun onCreateView(
        ...
        val fragmentBinding = FragQ1Binding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        nextButton.setOnClickListener {
            ...
            if (selectedOption == -1) {
                ...
                findNavController().navigate(R.id.action_quiz1_to_quiz2)
            }
        }
    }
