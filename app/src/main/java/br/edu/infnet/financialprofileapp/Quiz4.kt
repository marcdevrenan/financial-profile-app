...
import br.edu.infnet.financialprofileapp.databinding.FragQ4Binding

class Quiz4 : Fragment(R.layout.frag_q4) {
    var radioGroup: RadioGroup? = null
    lateinit var radioButton: RadioButton
    private var binding: FragQ4Binding? = null
    ...
    override fun onCreateView(
        ...
        val fragmentBinding = FragQ4Binding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        nextButton.setOnClickListener {
            ...
            if (selectedOption == -1) {
                ...
                findNavController().navigate(R.id.action_quiz4_to_quiz5)
            }
        }
    }
