...
import br.edu.infnet.financialprofileapp.databinding.FragQ5Binding

class Quiz5 : Fragment(R.layout.frag_q5) {
    var radioGroup: RadioGroup? = null
    lateinit var radioButton: RadioButton
    private var binding: FragQ5Binding? = null
    ...
    override fun onCreateView(
        ...
        val fragmentBinding = FragQ5Binding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        nextButton.setOnClickListener {
            ...
            if (selectedOption == -1) {
                ...
                findNavController().navigate(R.id.action_quiz5_to_quiz6)
            }
        }
    }
