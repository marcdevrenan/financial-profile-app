...
import br.edu.infnet.financialprofileapp.databinding.FragQ2Binding

class Quiz2 : Fragment(R.layout.frag_q2) {
    var radioGroup: RadioGroup? = null
    lateinit var radioButton: RadioButton
    private var binding: FragQ2Binding? = null
    ...
    override fun onCreateView(
        ...
        val fragmentBinding = FragQ2Binding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        nextButton.setOnClickListener {
            ...
            if (selectedOption == -1) {
                ...
                findNavController().navigate(R.id.action_quiz2_to_quiz3)
            }
        }
    }
