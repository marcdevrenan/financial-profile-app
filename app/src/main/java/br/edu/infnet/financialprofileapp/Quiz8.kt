...
import br.edu.infnet.financialprofileapp.databinding.FragQ8Binding

class Quiz8 : Fragment(R.layout.frag_q8) {
    var radioGroup: RadioGroup? = null
    lateinit var radioButton: RadioButton
    private var binding: FragQ8Binding? = null
    ...
    override fun onCreateView(
        ...
        val fragmentBinding = FragQ8Binding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        nextButton.setOnClickListener {
            ...
            if (selectedOption == -1) {
                ...
                findNavController().navigate(R.id.action_quiz8_to_quiz9)
            }
        }
    }
